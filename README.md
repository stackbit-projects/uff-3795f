...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6003795fd5321900162ae62e
...
To start editing your site, you can use the Sanity interface at https://uff-3795f.sanity.studio/.
...
Generated at `2021-01-16T23:42:20.475Z` by Stackbit version `0.3.42`.